              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text("What service do you need?", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 22),)
                  ),
                  Row(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Center(
                          child: Text("Nurse Services", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)
                        ),
                      ...
                      Text("Hour service", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                      Text("Days service", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                    ],
                  ),
                ],
              ),
                          ...
                          Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                value: "Application",
                                isExpanded: true,
                                icon: Icon(Icons.arrow_drop_down, color: Color.fromRGBO(61, 139, 255, 1),),
                                onChanged: (String value){

                                },
                                items: <String>["Application"]
                                  .map<DropdownMenuItem<String>>((String value){
                                    return DropdownMenuItem<String>(
                                      value: value,
                                      child: Text(value, style: TextStyle(fontSize: 13, color: Color.fromRGBO(61, 139, 255, 1), fontWeight: FontWeight.w900),),
                                    );
                                  }).toList(),
                              ),
                            ),
