...
class ClinicBookTimeSlot extends StatefulWidget {
  @override
  _ClinicBookTimeSlotState createState() => _ClinicBookTimeSlotState();
}

class _ClinicBookTimeSlotState extends State<ClinicBookTimeSlot> {
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              Text("Ashwini Eye Clinic", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, ),)
                            ],
                          ),
