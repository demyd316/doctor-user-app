...
class PharmacyPaymentMethod extends StatefulWidget {
  @override
  _PharmacyPaymentMethodState createState() => _PharmacyPaymentMethodState();
}

class _PharmacyPaymentMethodState extends State<PharmacyPaymentMethod> {
    @override
