import 'package:doctorgo_doctor/views/doctor_nearby/doctor_nearby_time_slot.dart';
import 'package:flutter/material.dart';

class DoctorNearbyDaySlot extends StatefulWidget {
  @override
  _DoctorNearbyDaySlotState createState() => _DoctorNearbyDaySlotState();
}

class _DoctorNearbyDaySlotState extends State<DoctorNearbyDaySlot> {
                              ...
                              children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Text("Dr.Jitendra Raut", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                                          Padding(
                                ...
                                FloatingActionButton(
                                  ...
                                  onPressed: (){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (_) => DoctorNearbyTimeSlot()),
                                    );
                                  },
