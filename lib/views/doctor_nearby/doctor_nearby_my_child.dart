...
class DoctorNearbyMyChild extends StatefulWidget {
  @override
  _DoctorNearbyMyChildState createState() => _DoctorNearbyMyChildState();
}
enum SingingCharacter { male, female }
class _DoctorNearbyMyChildState extends State<DoctorNearbyMyChild> {
