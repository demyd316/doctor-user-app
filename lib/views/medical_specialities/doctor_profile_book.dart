...
class DoctorProfileBook extends StatefulWidget {
  @override
  _DoctorProfileBookState createState() => _DoctorProfileBookState();
}

class _DoctorProfileBookState extends State<DoctorProfileBook> {
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  MaterialButton(
                                    color: Color.fromRGBO(203, 233, 230, 1),
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                      ...
                                      children: <Widget>[
                                        Text(
                                          ...
                                          style: TextStyle(
                                            ...
                                            color: Color.fromRGBO(0, 190, 170, 1),
                                          ),
                                        )
                                      ],
                                    ),
