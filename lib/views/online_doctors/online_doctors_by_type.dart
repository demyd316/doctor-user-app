...
class OnlineDoctorsByType extends StatefulWidget {
  @override
  _OnlineDoctorsByTypeState createState() => _OnlineDoctorsByTypeState();
}

class _OnlineDoctorsByTypeState extends State<OnlineDoctorsByType> {
      ...
      body: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              margin: EdgeInsets.only(top: 137, left: 15, right: 15),
              child: Card(
                elevation : 3, 
                child: Container(
                  width: MediaQuery.of(context).size.width,
