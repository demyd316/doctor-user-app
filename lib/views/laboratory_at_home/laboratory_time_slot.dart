import 'package:doctorgo_doctor/views/laboratory_at_home/laboratory_book_screen.dart';
import 'package:flutter_calendar_carousel/flutter_calendar_carousel.dart';
import 'package:intl/intl.dart' show DateFormat;
import 'package:flutter_calendar_carousel/classes/event.dart';
import 'package:flutter/material.dart';
class LaboratoryTimeSlot extends StatefulWidget {
  @override
  _LaboratoryTimeSlotState createState() => _LaboratoryTimeSlotState();
}

class _LaboratoryTimeSlotState extends State<LaboratoryTimeSlot> {
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (_) => LaboratoryBookScreen())
                                    );
                                  },
                                  child: Container(
                                    height: 50,
