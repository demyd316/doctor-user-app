...
class LaboratoryAdult extends StatefulWidget {
  @override
  _LaboratoryAdultState createState() => _LaboratoryAdultState();
}
enum SingingCharacter { male, female }
class _LaboratoryAdultState extends State<LaboratoryAdult> {
