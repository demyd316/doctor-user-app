...
class LaboratoryBookScreen extends StatefulWidget {
  @override
  _LaboratoryBookScreenState createState() => _LaboratoryBookScreenState();
}

class _LaboratoryBookScreenState extends State<LaboratoryBookScreen> {
  @override
