...
class PastMedicinesAddPage extends StatefulWidget {
  @override
  _PastMedicinesAddPageState createState() => _PastMedicinesAddPageState();
}

class _PastMedicinesAddPageState extends State<PastMedicinesAddPage> {
